  ...
  return (
    ...
    <section className="overflow-hidden bg-eb-very-light-gray pb-20 ">
      <div className="flex flex-col items-center justify-center sm:mx-auto sm:max-w-[1440px] sm:flex-row">
        <div className="hero-bg mb-6 h-full sm:absolute sm:right-0 sm:top-0 sm:min-w-[50dvw]">
        ...
        <div className="px-6 text-center sm:order-first sm:max-w-[50dvw] sm:text-left">
